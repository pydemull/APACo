...
We suggest two approaches to reproduce the analyses of the APA&Co project : running the analytical pipeline on a PC and its current system settings; or running the analytical pipeline on the web with GitHub Actions and Docker. These two approaches are some advantages and limits depending on you are interested by the understanding or the reproducibility of the analyses.
