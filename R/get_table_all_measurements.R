...
#' Get a table of descriptive statistics for all measurements relating to 6MWT, IPAQ, and EMAPS
#'     measurements (APA & Co project)
#'
#' @param data1  'DB_6MWT' dataframe (from APA & Co project analysis pipeline).
#' @param data2  'IPAQ' dataframe (from APA & Co project analysis pipeline).
#' @param data3  'EMAPS' dataframe (from APA & Co project analysis pipeline).
#'
